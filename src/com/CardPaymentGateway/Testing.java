...
//            String tobase64String = new BASE64Encoder().encode(jsonString.getBytes());//. Base64.getEncoder().encodeToString(jsonString.getBytes());
            ...
            //Auth key
            String clientKey="eR64MOHxeI";
            String organizationid="10";
            String tranid="3546";
//            String authKeyString = uniqueKey + phoneNumber;
            String authKeyString = clientKey + organizationid + tranid;
            System.out.println(authKeyString);
            //base64 of authKey
            Testing test=new  Testing();
            String base64AuthString1= test.EncodeMessage(authKeyString);
            System.out.println("base64 string1 ="+base64AuthString1);
            ...
            System.out.println("base64 string="+base64AuthString);
